...
const{getHomePage, checkUserConfirmPassword,getWelcomePage,homeProducts,getProfilePicture, updateProfilePicture,makeProductEnquiry,forgotPassword, changeUserDetails, getOfferMessages,getPaymentsPage, postSearchBox,getaccountFavouriteAds,getAccountProfileSetting , getAccountMyAds,getDashboardPage, sendMessage,getAdListSection,getCategorySections,getAdgridSection, getadGridPage,logOut, checkUsername, authenticateLogin, getCategoriesPage, postAdvertsToDatabase, getUserDetails, getRegisterPage, getLoginPage,getadListPage,getadListDetailPage, getaboutPage,getServicesPage,getpostAdsPage,getPackagesPage,deleteDashboardPosts,gettestimonialPage,getfaqPage,get404Page,getBlogRightSidePage,getBlogLeftSidePage,getBlogGridFullWidthPage,getBlogDetailsPage,getContactPage,postMessageToAdmin} = require('../controllers/homeControllers')
...
routes.get('/offermessages/:id', setUser, getOfferMessages)
...
routes.post('/updatePicture', setUser,updateProfilePicture)
routes.get('/ProfilePicture', setUser,getProfilePicture)
